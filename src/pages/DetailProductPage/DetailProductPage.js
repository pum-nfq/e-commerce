            ...
            <div className="detail-product-page-wrapper">
                <div className="detail-product">
                    <div className="detail-product__carousel">
                        ...
                        >
                            {product.detailImage &&
                                [product.image, ...product.detailImage].map(
                                    (img, index) => (
                    ...
                    <div className="detail-product__content">
                        ...
                        >
                            ...
                            <h2 className="detail-product__content__price">
                                {productSelectedSize &&
                                    productSelectedSize.price.toLocaleString(
                                        'en-US',
                                        {
                                            style: 'currency',
                                            currency: 'USD',
                        ...
                        <Tabs defaultActiveKey="1">
                            <TabPane tab="Description" key="1">
                                <p style={{ marginBottom: '1rem' }}>
                                    The <i>{product.name}</i> fuses court and
                                    street style to give you a slam dunk
                                    sneaker. The mixed material upper features
                                    transparent mesh panels for breathability,
                                    while the collapsible heel brings feminine
                                    flair to Nike b-ball.
                                </p>
                                <b style={{ fontSize: '1.25rem' }}>
                                    Product details
                                </b>
                                <p>
                                    <b>Package Dimensions:</b> 33.71 x 20.9 x
                                    11.4 cm
                                    <br />
                                    <b>Date First Available:</b> 17 December
                                    2021
                                    <br />
